      ...
      <div class="flex h-screen relative">
        ...
        <div id="admin-sidebar" class="fixed md:static inset-y-0 left-0 z-50 w-64 md:w-72 bg-white border-r shadow-xl overflow-y-auto transform -translate-x-full md:translate-x-0 transition-transform duration-200">
          ...
          <nav class="p-3 md:p-4 space-y-0.5 text-sm md:text-base">
            ...
            <a data-permiso="ventas" href="ventas.html" class="flex items-center gap-3 px-3 md:px-4 py-2.5 md:py-3 rounded-xl md:rounded-2xl hover:bg-green-50 cursor-pointer"><i class="fas fa-chart-pie w-5 text-center text-sm"></i> Ventas</a>
            ...
            <a data-permiso="caja" onclick="navegarAdmin('caja')" class="flex items-center gap-3 px-3 md:px-4 py-2.5 md:py-3 rounded-xl md:rounded-2xl hover:bg-green-50 cursor-pointer"><i class="fas fa-money-bill-wave w-5 text-center text-sm"></i> Caja (POS)</a>
